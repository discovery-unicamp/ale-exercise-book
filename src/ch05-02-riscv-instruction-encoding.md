...
- Refer to the [RISC-V Instruction Set Manual](https://drive.google.com/file/d/1uviu1nH-tScFfgrovvFCrj7Omv8tFtkp/view?usp=drive_link) to check how each instruction is encoded. Especially, consult the RV32I Base Instruction Set on page 609. For information regarding the encoding of immediates, check Section 2.3 on pages 26 and 27.
