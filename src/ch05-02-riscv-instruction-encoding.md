...
- Refer to the [Practical Guide to RISC-V: Atlas of an Open Architecture](http://riscvbook.com/portuguese/) to check how each instruction is encoded. Especially, consult the beginning of Chapter 2 and Figure 2.3. For information regarding the encoding of immediates, check Section 2.3 of the [RISC-V Instruction Set Manual](https://riscv.org/wp-content/uploads/2017/05/riscv-spec-v2.2.pdf), especially Figures 2.3 and 2.4.
