...
- You can use this [base code](https://github.com/discovery-unicamp/ale-exercise-book/reference_code/ch05-02/base_code.c) as a starting point, or build your solution from scratch if you want.
- Refer to the [Practical Guide to RISC-V: Atlas of an Open Architecture](http://riscvbook.com/portuguese/) to check how each instruction is encoded. Especially, consult the beginning of Chapter 2 and Figure 2.3.
