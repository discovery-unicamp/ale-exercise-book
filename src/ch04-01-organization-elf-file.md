...
- Refer to the [Practical Guide to RISC-V: Atlas of an Open Architecture](http://riscvbook.com/portuguese/) to decode the instructions. Especially, consult the beginning of Chapter 2 and Figure 2.3.
